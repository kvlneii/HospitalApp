...
namespace HospitalApp.Migrations
{
    ...
    [Migration("20230908152253_SeedingTables")]
            ...
            modelBuilder.Entity("HospitalApp.Entitites.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            Birthdate = new DateTime(1973, 9, 8, 17, 22, 53, 366, DateTimeKind.Local).AddTicks(2424),
                            FirstName = "Philip",
                            LastName = "Stafford"
                        },
                        new
                        {
                            IdPatient = 2,
                            Birthdate = new DateTime(1993, 9, 8, 17, 22, 53, 366, DateTimeKind.Local).AddTicks(2480),
                            FirstName = "Hollie",
                            LastName = "Eaton"
                        },
                        new
                        {
                            IdPatient = 3,
                            Birthdate = new DateTime(2004, 9, 8, 17, 22, 53, 366, DateTimeKind.Local).AddTicks(2483),
                            FirstName = "Kimberley",
                            LastName = "Fernandez"
                        },
                        new
                        {
                            IdPatient = 4,
                            Birthdate = new DateTime(1956, 9, 8, 17, 22, 53, 366, DateTimeKind.Local).AddTicks(2487),
                            FirstName = "Rueben",
                            LastName = "Lowery"
                        });
                });
            ...
            modelBuilder.Entity("HospitalApp.Entitites.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2023, 9, 3, 17, 22, 53, 367, DateTimeKind.Local).AddTicks(9173),
                            DueDate = new DateTime(2023, 10, 8, 17, 22, 53, 367, DateTimeKind.Local).AddTicks(9229),
                            IdDoctor = 2,
                            IdPatient = 1
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2023, 11, 7, 17, 22, 53, 367, DateTimeKind.Local).AddTicks(9233),
                            IdDoctor = 5,
                            IdPatient = 4
                        },
                        new
                        {
                            IdPrescription = 3,
                            Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DueDate = new DateTime(2023, 10, 28, 17, 22, 53, 367, DateTimeKind.Local).AddTicks(9236),
                            IdDoctor = 5,
                            IdPatient = 3
                        },
                        new
                        {
                            IdPrescription = 4,
                            Date = new DateTime(2023, 8, 27, 17, 22, 53, 367, DateTimeKind.Local).AddTicks(9239),
                            DueDate = new DateTime(2023, 10, 8, 17, 22, 53, 367, DateTimeKind.Local).AddTicks(9241),
                            IdDoctor = 3,
                            IdPatient = 2
                        });
                });
